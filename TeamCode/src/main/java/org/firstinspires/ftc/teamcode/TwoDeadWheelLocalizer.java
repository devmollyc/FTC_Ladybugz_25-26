...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1836.6443954789393; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3109.2293164534535; // x position of the perpendicular encoder (in tick units)
    }
